...
const Post = () => {
  return (
    <div className="rounded-3xl overflow-hidden w-full h-[300px] mt-2 flex bg-white shadow-2xl">
      ...
      <div className="relative flex-1">
        ...
        <div className="absolute bottom-0 flex justify-between w-full">
          <div className="m-3"><FavoriteBorderIcon fontSize="large" className="" /></div>
